...
public class GetRequestValidation_Test extends API_Validations {
public String EndpointURI="http://dummy.restapiexample.com/api/v1/employees";
int statusc;
...
//Method to return in XML Format
public void initializationXML() {
	initSetup(EndpointURI);
	RequestSetupXML("GET");
	ResponseSetup("GET","");
}
...
//	 ExtentTest t=extent.createTest("Employee End Point Status code validations","GetRequest");
...
@Test
public void bodyvalidation_GetRequest() {
//	 ExtentTest t=extent.createTest("Employee Response Body Validations","GetRequest");	
//	t.log(Status.INFO, "Response Body Validation");
	int EmployeeActualCount=24;
	try {
	resBodyValidation(EmployeeActualCount);
